  ...
  MOODS = [
    {
      ...
      icon: '😊',
      category: 'カジュアル',
      restaurant_categories: ['カジュアル', '和食', '定食'],
    ...
    },
    {
      ...
      icon: '😵',
      category: '回復系',
      restaurant_categories: ['定食', '和食', 'カフェ', 'ラーメン'],
      google_types: ['restaurant', 'cafe']
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: '🍜',
      category: 'ボリューム系',
      restaurant_categories: ['ラーメン', '焼肉', '定食', '丼もの'],
    ...
    },
    {
      ...
      icon: '🍕',
      category: 'ファストフード',
      restaurant_categories: ['ファストフード', 'カフェ', 'テイクアウト'],
    ...
    },
    {
      ...
      icon: '🍷',
      category: '高級店',
      restaurant_categories: ['フレンチ', 'イタリアン', '高級和食', 'バー'],
    ...
    },
    {
      ...
      icon: '🎉',
      category: 'にぎやか',
      restaurant_categories: ['居酒屋', '焼肉', 'バル', 'バー'],
    ...
    },
    {
      ...
      icon: '☕',
      category: 'カフェ系',
      restaurant_categories: ['カフェ', 'スイーツ', 'バー'],
